...
import (
	...
	siloutilization "github.com/oxidecomputer/terraform-provider-oxide/internal/provider/silo_utilization"
...
func (p *oxideProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		systemippool.NewResource,
		systemippoolrange.NewResource,
		systemippoolsilolink.NewResource,
