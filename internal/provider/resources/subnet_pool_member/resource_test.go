...
package subnet_pool_member_test
...
func TestAccResourceSubnetPoolMember_full(t *testing.T) {
	...
	subnet1 := provider.NextSubnetCIDR(t)
	subnet2 := provider.NextSubnetCIDR(t)
...
func TestAccResourceSubnetPoolMember_parallel(t *testing.T) {
	...
	sub1 := provider.NextSubnetCIDR(t)
	sub2 := provider.NextSubnetCIDR(t)
	sub3 := provider.NextSubnetCIDR(t)
