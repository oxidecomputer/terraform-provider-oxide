...
func checkResourceSilo(resourceName string, siloName string) resource.TestCheckFunc {
	return resource.ComposeAggregateTestCheckFunc([]resource.TestCheckFunc{
		...
		resource.TestCheckResourceAttrSet(resourceName, "tls_certificates.0.name"),
		resource.TestCheckResourceAttrSet(resourceName, "tls_certificates.0.description"),
		resource.TestCheckResourceAttrSet(resourceName, "tls_certificates.0.cert"),
		resource.TestCheckResourceAttrSet(resourceName, "tls_certificates.0.key"),
		resource.TestCheckResourceAttrSet(resourceName, "tls_certificates.0.service"),
